      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <motion.div
            {...fadeUp}
            viewport={{ once: true }}
            className="bg-white border-l-4 border-green-500 p-6 rounded-lg shadow hover:shadow-lg transition-shadow"
          >
            <div className="mb-4">
          ...
          <motion.div
            {...fadeUp}
            viewport={{ once: true }}
            className="bg-white border-l-4 border-red-500 p-6 rounded-lg shadow hover:shadow-lg transition-shadow"
          >
            <div className="mb-4">
          ...
          <motion.div
            {...fadeUp}
            viewport={{ once: true }}
            className="bg-white border-l-4 border-blue-500 p-6 rounded-lg shadow hover:shadow-lg transition-shadow"
          >
            <div className="mb-4">
          ...
          <motion.div
            {...fadeUp}
            viewport={{ once: true }}
            className="bg-white border-l-4 border-purple-500 p-6 rounded-lg shadow hover:shadow-lg transition-shadow"
          >
            <div className="mb-4">
